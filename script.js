...
function clik (btn){
  btn.textContent == "Haii juga 🤗" ? img.src = "img/malu.gif" : img.src = "img/patahHati.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "270px"
  ctn.style.width = "270px"
  return btn.textContent == "Haii juga 🤗" ? kata.textContent = "😊 Lolos Step Selanjutnya nih hehehe" : kata.textContent = "😭😭😭😭😭😭"
...
function content(){
  ...
  kata.textContent = "Cuma mau ucapin, Haii Ajasih Sher 😊"
}
